...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/common/checkUsernameAvailable.tpl', 1, false),array('block', 'ts', 'CRM/common/checkUsernameAvailable.tpl', 46, false),array('function', 'crmSigner', 'CRM/common/checkUsernameAvailable.tpl', 27, false),array('function', 'crmURL', 'CRM/common/checkUsernameAvailable.tpl', 66, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo smarty_function_crmSigner(array('var' => 'checkUserSig','for' => "civicrm/ajax/cmsuser"), $this);?>
...
"<?php echo ';
   ...
   var checkUserParams = {
       ...
       ts: '; ?>
"<?php echo $this->_tpl_vars['checkUserSig']['ts']; ?>
"<?php echo ',
       sig: '; ?>
"<?php echo $this->_tpl_vars['checkUserSig']['signature']; ?>
"<?php echo ',
