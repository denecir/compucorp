<?php /* Smarty version 2.6.27, created on 2016-09-19 20:40:10
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo '</div></div>'; ?><?php endif; ?><?php echo ''; ?><?php elseif (((is_array($_tmp=$this->_tpl_vars['n'])) ? $this->_run_mod_handler('substr', true, $_tmp, 0, 5) : substr($_tmp, 0, 5)) == 'phone'): ?><?php echo ''; ?><?php $this->assign('phone_ext_field', ((is_array($_tmp=$this->_tpl_vars['n'])) ? $this->_run_mod_handler('replace', true, $_tmp, 'phone', 'phone_ext') : smarty_modifier_replace($_tmp, 'phone', 'phone_ext'))); ?><?php echo ''; ?><?php echo $this->_tpl_vars['form'][$this->_tpl_vars['n']]['html']; ?><?php echo ''; ?><?php if ($this->_tpl_vars['form'][$this->_tpl_vars['phone_ext_field']]['html']): ?><?php echo '&nbsp;'; ?><?php echo $this->_tpl_vars['form'][$this->_tpl_vars['phone_ext_field']]['html']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php if (( ( $this->_tpl_vars['n'] == 'birth_date' ) || ( $this->_tpl_vars['n'] == 'deceased_date' ) || ( $this->_tpl_vars['n'] == 'activity_date_time' ) ) && $this->_tpl_vars['field']['is_view'] != 1): ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo ''; ?><?php if ($this->_tpl_vars['isDuplicate']): ?><?php echo '<span class="crm-button">'; ?><?php echo $this->_tpl_vars['form']['_qf_Edit_upload_duplicate']['html']; ?><?php echo '</span>'; ?><?php endif; ?><?php echo '<a class="button cancel" href="'; ?><?php echo $this->_tpl_vars['cancelURL']; ?><?php echo '"><span><i class="crm-i fa-times"></i>'; ?><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo 'Cancel'; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php echo '</span></a></div>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['help_post'] && $this->_tpl_vars['action'] != 4): ?><?php echo '<br /><div class="messages help">'; ?><?php echo $this->_tpl_vars['help_post']; ?><?php echo '</div>'; ?><?php endif; ?><?php echo ''; ?>
