<?php /* Smarty version 2.6.27, created on 2016-09-19 20:48:08
         compiled from CRM/Contribute/Form/ContributionPage/Custom.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contribute/Form/ContributionPage/Custom.tpl', 1, false),array('block', 'ts', 'CRM/Contribute/Form/ContributionPage/Custom.tpl', 28, false),array('function', 'help', 'CRM/Contribute/Form/ContributionPage/Custom.tpl', 28, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><div class="crm-block crm-form-block crm-contribution-contributionpage-custom-form-block">
<div class="help">
 ...
 ?></div>
    ...
    <tr class="crm-contribution-contributionpage-custom-form-block-custom_post_id">
       ...
       <td class="html-adjust"><?php echo $this->_tpl_vars['form']['custom_post_id']['html']; ?>
          ...
          <span class="description"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Profile to be included at the bottom of the page.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span>
       </td>
    </tr>
</table>
<div class="crm-submit-buttons"><?php $_smarty_tpl_vars = $this->_tpl_vars;
