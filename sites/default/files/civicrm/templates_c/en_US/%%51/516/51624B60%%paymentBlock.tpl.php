...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/common/paymentBlock.tpl', 1, false),array('function', 'crmURL', 'CRM/common/paymentBlock.tpl', 108, false),)), $this); ?>
...
&<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('profilePathVar', ob_get_contents());ob_end_clean(); ?>
      ...
      var dataUrl = "<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/payment/form','h' => 0,'q' => "currency=".($this->_tpl_vars['currency'])."&".($this->_tpl_vars['urlPathVar']).($this->_tpl_vars['profilePathVar']).($this->_tpl_vars['contributionPageID']).($this->_tpl_vars['preProfileID'])."processor_id="), $this);?>
" + type;
      <?php echo '
