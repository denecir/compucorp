...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:Mutter04111951@127.0.0.1/drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:Mutter04111951@127.0.0.1/civicrm?new_link=true');
  }
}
...
$civicrm_root = '/Library/WebServer/Documents/estudos/drupal/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Library/WebServer/Documents/estudos/drupal/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost:8080/estudos/drupal/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'e615be96d3965a22db1dfbf293547538');
}
...
// define( 'CIVICRM_MAIL_LOG', '/Library/WebServer/Documents/estudos/drupal/sites/default/files/civicrm/templates_c//mail.log');
// }
